...
Lesson.create!([
  {title: "Basic Building Blocks", subtitle: "This lesson teaches you the basics of HTML code and how to start building new pages", section_id: 2, video: "big_buck_bunny.mp4", row_order: nil},
  {title: "Getting a HEAD", subtitle: "Learn what the HEAD tag is and what goes inside", section_id: 2, video: "small.mp4", row_order: nil},
  {title: "Cascading Style Sheets for Dummies", subtitle: "Style your way to beautiful web apps", section_id: 3, video: "small.mp4", row_order: nil},
  {title: "SASS", subtitle: "CSS with flair", section_id: 3, video: "big_buck_bunny.mp4", row_order: nil},
  {title: "Lesson 0", subtitle: nil, section_id: 1, video: nil, row_order: 0},
  {title: "Basic Ruby Syntax", subtitle: "common syntax cheatsheet", section_id: 1, video: nil, row_order: 4194304},
